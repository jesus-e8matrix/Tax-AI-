...
import Label from "../../Label"; // plasmic-import: pj2qurJlWTWX/component
import TextInput from "../../TextInput"; // plasmic-import: rOL53Ae4m72k/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: U3UmUf1MvfGn/component
import Description from "../../Description"; // plasmic-import: J7ZSDwwVqGUZ/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: A_y8NAu0wV3a/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__v06VG, {
          [sty.freeBoxiconEnd__v06VGXuUBv]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__v06VGl1CJx]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__v06VGwcTw3]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__kbkWs, {
            [sty.freeBoxiconStart__kbkWSl1CJx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__kbkWSwcTw3]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__tOgoo)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__sq7B, {
            [sty.freeBoxiconEnd__sq7BXuUBv]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__sq7Bl1CJx]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__aFtre)}
                role={"img"}
              />
            ),
