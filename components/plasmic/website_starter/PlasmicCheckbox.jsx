...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: ptoitlZzcWXg/css
import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: -o_tTOAW7PT1/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: _BQZi2n4rv8X/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg___0Q5Rm)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg___00D8A)}
            role={"img"}
          />
        ) : null}
      </div>
